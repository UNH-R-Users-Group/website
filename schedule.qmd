...
6.  [Guide for choosing models](https://pmc.ncbi.nlm.nih.gov/articles/PMC8187274/#ecy3336-sec-0004)
7.  [Guide to creating pdf documents using Quarto](https://quarto.org/docs/guide/)
8.  [Guide to publishing manuscripts using Quarto](https://quarto.org/docs/manuscripts/)
