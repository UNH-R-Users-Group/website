...
3.  [Data wrangling in R: load, explore, transform, and visualize data for modeling tidyverse libraries](https://learning.oreilly.com/library/view/data-wrangling-with/9781803235400/) (UNH students/faculty can access via the UNH Library) 4.[Choosing a graph type](https://www.data-to-viz.com/)
4. [Guide to creating pdf documents using Quarto](https://quarto.org/docs/guide/)
