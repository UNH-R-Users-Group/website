...
1.  Learning R in R using package [swirl](https://swirlstats.com/students.html) 2Helpful website for asking questions: [Stackoverflow](https://stackoverflow.com)
...
4.  [Choosing a graph type](https://www.data-to-viz.com/)
