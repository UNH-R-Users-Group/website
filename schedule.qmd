...
12\. [Guide for formatting markdown documents - works in lots of
programs](https://rmd4sci.njtierney.com/)

13\. [GitHub CoPilot for students &
faculty](https://docs.github.com/en/copilot/managing-copilot/managing-copilot-as-an-individual-subscriber/managing-your-github-copilot-pro-subscription/getting-free-access-to-copilot-pro-as-a-student-teacher-or-maintainer)
...
library(fontawesome)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/1k4RPfWwKVxPpp4wRDEc08KDxzBLG3vOcWMC6_hsF648/edit?gid=0#gid=0", sheet = "Fall2025")
```
...
d <- read_sheet("https://docs.google.com/spreadsheets/d/1k4RPfWwKVxPpp4wRDEc08KDxzBLG3vOcWMC6_hsF648/edit?gid=0", sheet = "Fall2025")
